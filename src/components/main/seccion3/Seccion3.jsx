...
export const Seccion3 = () => {
  ...
  useEffect(() => {
    new hoverEffect({
      ...
      intensity: 0.3,
      image1:
        "https://ik.imagekit.io/mrprwema7/loose/productos/img_sec3_Vt8eK1wCK.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1656550224885",
      image2:
        "https://ik.imagekit.io/mrprwema7/loose/productos/img_sec3_2_aWh2Q7ZsV.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1656550789967",
      displacementImage:
    ...
    <section className="seccion3__container">
      ...
      >
        ...
        <motion.div className="seccion__text-p" variants={scrollAnimateUp}>
          <p>
            Loose es una marca que se creo para vivir experiencias únicas, ya
            que se enfoca en un estilo holgado y suelto, para sentirnos libre en
